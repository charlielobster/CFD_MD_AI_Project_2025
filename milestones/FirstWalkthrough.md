...
The paper drills down into two existing PDE ML solvers, Finite-dimensional Operators and Neural-FEM, the former are by definition mesh-dependent and the later, although mesh-independent and accurate, suffer due to the classical nature of their models. 
